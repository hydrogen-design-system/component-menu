...
// Focusable Items
function h2ComMenFocusable$H2VERJS(focusElement) {
...
// Mobile Menu Scripts
    ...
    // Mobile Menu Tabbing
        ...
        // Tab Loop Function
        function h2ComMenMobileTabLoop$H2VERJS(e, menuItems, menuItemCount) {
        ...
        // Tab Loop Trigger
        function h2ComMenMobileMenuTabLoopTrigger$H2VERJS(menuItems) {
            ...
            $(menuItems).on("keydown.mobilemenutabloop", function(e) {
                h2ComMenMobileTabLoop$H2VERJS(e, menuItems, menuItemCount);
            });
        }
    ...
    // Mobile Menu Escape Events
        ...
        // Escape Function
        function h2ComMenMobileMenuEscape$H2VERJS(e, trigger, menu, menuItems) {
            var keyCode = e.keyCode || e.which;
            if (keyCode == 27) {
        ...
        // Escape Trigger
        function h2ComMenMobileMenuEscapeTrigger$H2VERJS(trigger, menu, menuItems) {
            // Trigger the escape event listener on the submenu items.
            $(menuItems).on("keydown.mobilemenuescape", function(e) {
                h2ComMenMobileMenuEscape$H2VERJS(e, trigger, menu, menuItems);
            });
        }
    ...
    // Mobile Menu Trigger
        ...
        function h2ComMenMobileMenuToggle$H2VERJS(trigger) {
            ...
            // If the mobile trigger is inactive, open the menu.
                ...
                h2ComMenMobileMenuTabLoopTrigger$H2VERJS(menuItems);
                h2ComMenMobileMenuEscapeTrigger$H2VERJS(trigger, menu, menuItems);
            }
        }

        // Event Listener
        $("[data-h2-menu-wrapper$H2VERCSS] [data-h2-mobile-menu-trigger]").on("click", function(e) {
            e.preventDefault();
    ...
    function h2ComMenMobileMenuAnchorClick$H2VERJS(trigger) {
    ...
    $("[data-h2-menu-wrapper$H2VERCSS] [data-h2-menu] [role='menuitem']").on("click", function(e) {
...
// Desktop Menu Scripts
    ...
    // Submenu Tab Loop
    function h2ComMenSubmenuTabLoop$H2VERJS(e, submenuItems, submenuItemCount) {
        var keyCode = e.keyCode || e.which;
        if (keyCode == 9 && !e.shiftKey) {
            e.preventDefault();
            var currentFocus = document.activeElement;
    ...
    function h2ComMenSubmenuTabLoopTrigger$H2VERJS(trigger, submenu) {
        ...
        $(submenuItems).on("keydown.submenutabloop", function(e) {
            h2ComMenSubmenuTabLoop$H2VERJS(e, submenuItems, submenuItemCount);
        });

    }

    // Submenu Escape Loop
    function h2ComMenSubmenuEscape$H2VERJS(e, trigger, parentMenuItem, parentSubmenu, parentSubmenuTrigger, submenu, submenuItems) {
        var keyCode = e.keyCode || e.which;
        if (keyCode == 27) {
            // Remove the current submenu's tab loop and escape event listeners.
            ...
            if ($(parentSubmenu).h2ComMenHasAttr$H2VERJS("data-h2-submenu") == true) {
                h2ComMenSubmenuTabLoopTrigger$H2VERJS(parentSubmenuTrigger, parentSubmenu);
                h2ComMenSubmenuEscapeTrigger$H2VERJS(parentSubmenuTrigger);
            }
            // Otherwise check to see if the parent is the main menu.
                ...
                var mobileTrigger = $(parentSubmenu).closest("[data-h2-menu-wrapper$H2VERCSS]").find("[data-h2-mobile-menu-trigger]");
                menuItems = $(menuItems).add($(mobileTrigger));
                // Enable the tab loop and escape event listeners.
                h2ComMenMobileMenuTabLoopTrigger$H2VERJS(menuItems);
                h2ComMenMobileMenuEscapeTrigger$H2VERJS(mobileTrigger, menu, menuItems);
            }
        }
    }

    function h2ComMenSubmenuEscapeTrigger$H2VERJS(trigger) {
        ...
        $(submenuItems).on("keydown.submenuescape", function(e) {
            h2ComMenSubmenuEscape$H2VERJS(e, trigger, parentMenuItem, parentSubmenu, parentSubmenuTrigger, submenu, submenuItems);
        });
    }
    ...
    // Submenu Trigger
        ...
        // Trigger Function
        function h2ComMenSubmenuToggle$H2VERJS(trigger) {
            ...
            // If the submenu isn't active, open it.
                ...
                h2ComMenSubmenuTabLoopTrigger$H2VERJS(trigger, submenu);
                // Add the escape event listeners to the newly opened submeny.
                h2ComMenSubmenuEscapeTrigger$H2VERJS(trigger);
            }

        }

        // Trigger Event
        $("[data-h2-menu-wrapper$H2VERCSS] [data-h2-submenu-trigger]").on("click.submenutrigger", function(e) {
            e.preventDefault();
            h2ComMenSubmenuToggle$H2VERJS(this);
        });