...
// "hasAttr" Function
$.fn.h2ComMenHasAttr0012 = function (name) {
...
// Toggle submenu.
  ...
  function h2ComMenOpenSubmenu0012(menuItem, subMenuTrigger) {
    ...
    $("[data-h2-menu-wrapper-0012] [data-h2-menu] *").off("keydown.upDownArrow");
    $("[data-h2-menu-wrapper-0012] [data-h2-menu] *").off("keydown.rightArrow");
    $("[data-h2-menu-wrapper-0012] [data-h2-menu] *").off("keydown.escape");
    $("[data-h2-menu-wrapper-0012] [data-h2-mobile-menu-trigger]").off("keydown.upDownArrow");
    $("[data-h2-menu-wrapper-0012] [data-h2-mobile-menu-trigger]").off("keydown.rightArrow");
    $("[data-h2-menu-wrapper-0012] [data-h2-mobile-menu-trigger]").off("keydown.escape");
  ...
  function h2ComMenCloseSubmenu0012(menuItem, subMenuTrigger) {
    ...
    if ($(menuItem).parent().parent().parent().h2ComMenHasAttr0012("data-h2-menu") == true) {
    ...
    if ($(menuItem).parent().parent("[data-h2-menulist]").parent().children("[data-h2-submenu-trigger]").length > 0) {
      ...
      if ($("[data-h2-menu-wrapper-0012] [data-h2-menu]").hasClass("h2-mobile-menu-active")) {
...
function h2ComMenEscapeTrigger0012(e, key, trigger) {
  if (key == 37 || key == 27) {
    ...
    if (trigger.getAttribute('role') === 'menuitem') {
      ...
      if ($(trigger).parent().parent().parent().h2ComMenHasAttr0012("data-h2-menu")) {
        // console.log("You're trying to close the main menu.");
        if ($("[data-h2-menu-wrapper-0012] [data-h2-menu]").hasClass("h2-mobile-menu-active")) {
          var menu = $("[data-h2-menu-wrapper-0012] [data-h2-menu]");
...
function h2ComMenMainTabExit0012(e, key, trigger) {
  ...
  function closeSubmenus() {
    ...
    $("[data-h2-menu-wrapper-0012] [data-h2-menu] >[data-h2-menulist]").each(function() {
      $(this).children("li").each(function() {
        if ($(this).children("[role='menuitem']")) {
  ...
  if ($("[data-h2-menu-wrapper-0012] [data-h2-menu]").hasClass("h2-mobile-menu-active")) {
    ...
    var menuItemIndex = [];
    menuItemIndex = $(menuItemIndex).add($("[data-h2-menu-wrapper-0012]").find(" [data-h2-mobile-menu-trigger]"));
    $("[data-h2-menu-wrapper-0012] [data-h2-menu] >[data-h2-menulist]").each(function() {
      $(this).children("li").each(function() {
        if ($(this).children("[role='menuitem']")) {
...
function h2ComMenMobileMenuToggle0012(trigger) {
  ...
  // Open the menu.
    ...
    $("[data-h2-menu-wrapper-0012] [data-h2-menu] *").off("keydown.rightArrow");
    $("[data-h2-menu-wrapper-0012] [data-h2-menu] *").off("keydown.escape");
    $("[data-h2-menu-wrapper-0012] [data-h2-menu] *").off("keydown.mainTabExit");
    $("[data-h2-menu-wrapper-0012] [data-h2-mobile-menu-trigger]").off("keydown.upDownArrow");
    $("[data-h2-menu-wrapper-0012] [data-h2-mobile-menu-trigger]").off("keydown.rightArrow");
    $("[data-h2-menu-wrapper-0012] [data-h2-mobile-menu-trigger]").off("keydown.escape");
    $("[data-h2-menu-wrapper-0012] [data-h2-mobile-menu-trigger]").off("keydown.mainTabExit");
    // Get main menu items.
    var resetMainMenuItems = [];
    $("[data-h2-menu-wrapper-0012] [data-h2-menu] >[data-h2-menulist]").each(function() {
      $(this).children("li").each(function() {
    ...
    $("[data-h2-menu-wrapper-0012] [data-h2-menu] [data-h2-menulist]").children("li").each(function() {
      if ($(this).children("[role='menuitem']")) {
...
function test70012() {
  ...
  $("[data-h2-menu-wrapper-0012] [data-h2-submenu-trigger]").on("click.toggleSubmenu", function() {
...
function test80012() {
  // Mobile Menu Trigger
  $("[data-h2-menu-wrapper-0012] [data-h2-mobile-menu-trigger]").on("click.toggleMobileMenu", function(e) {
    e.preventDefault();
...
function test90012() {
  ...
  $("[data-h2-menu-wrapper-0012] [data-h2-menu] [role='menuitem']").on("click.navigate", function() {
...
export {test20012, test40012, test60012, test70012, test80012, test90012};