...
// "hasAttr" Function
$.fn.h2ComMenHasAttr009 = function (name) {
...
// Toggle submenu.
    ...
    // Open script.
    function h2ComMenOpenSubmenu009(menuItem, subMenuTrigger) {
        // Open the submenu.
        $(menuItem).parent().addClass("h2-active");
        $(menuItem).attr("aria-expanded", "true");
        $(subMenuTrigger).attr("aria-expanded", "true");
        // Remove all event listeners.
        $("[data-h2-menu-wrapper-0-0-9] [data-h2-menu] *").off("keydown.upDownArrow");
        $("[data-h2-menu-wrapper-0-0-9] [data-h2-menu] *").off("keydown.rightArrow");
        $("[data-h2-menu-wrapper-0-0-9] [data-h2-menu] *").off("keydown.escape");
        $("[data-h2-menu-wrapper-0-0-9] [data-h2-mobile-menu-trigger]").off("keydown.upDownArrow");
        $("[data-h2-menu-wrapper-0-0-9] [data-h2-mobile-menu-trigger]").off("keydown.rightArrow");
        $("[data-h2-menu-wrapper-0-0-9] [data-h2-mobile-menu-trigger]").off("keydown.escape");
    ...
    // Close script.
    function h2ComMenCloseSubmenu009(menuItem, subMenuTrigger) {
        // Remove all event listeners.
        $("[data-h2-menu-wrapper-0-0-9] [data-h2-menu] *").off("keydown.upDownArrow");
        $("[data-h2-menu-wrapper-0-0-9] [data-h2-menu] *").off("keydown.rightArrow");
        $("[data-h2-menu-wrapper-0-0-9] [data-h2-menu] *").off("keydown.escape");
        ...
        if ($(menuItem).parent().parent("[data-h2-menulist]").parent().children("[data-h2-submenu-trigger]").length > 0) {
            ...
            if ($("[data-h2-menu-wrapper-0-0-9] [data-h2-menu]").hasClass("h2-mobile-menu-active")) {
        ...
        $(parentMenuItems).on("keydown.upDownArrow", function(e) {
            ...
            h2ComMenUpDownLoop009(e, key, parentMenuItems, itemCount);
        });
    ...
    function h2ComMenToggleSubmenu009(trigger) {
        ...
        if ($(trigger).parent().hasClass("h2-active")) {
            h2ComMenCloseSubmenu009(menuItem, subMenuTrigger);
        } else {
            h2ComMenOpenSubmenu009(menuItem, subMenuTrigger);
        }
    }

// Up/down arrow loop.
function h2ComMenUpDownLoop009(e, key, items, itemCount) {
    // Next item
    if (key == 40) {
        e.preventDefault();
...
function h2ComMenRightTrigger009(e, key, trigger) {
    if (key == 39) {
        e.preventDefault();
        ...
        if ($(trigger).siblings("[data-h2-menulist]").length > 0) {
            if ($(trigger).parent().hasClass("h2-active")) {
                ...
                // Open the submenu.
                h2ComMenToggleSubmenu009(trigger);
            }
        }
    }
}
...
function h2ComMenEscapeTrigger009(e, key, trigger) {
    if (key == 37 || key == 27) {
        e.preventDefault();
        ...
        if (trigger.getAttribute('role') === 'menuitem') {
            ...
            if ($(trigger).parent().parent().parent().h2ComMenHasAttr009("data-h2-menu")) {
                // console.log("You're trying to close the main menu.");
                if ($("[data-h2-menu-wrapper-0-0-9] [data-h2-menu]").hasClass("h2-mobile-menu-active")) {
                    var menu = $("[data-h2-menu-wrapper-0-0-9] [data-h2-menu]");
...
function h2ComMenMainTabExit009(e, key, trigger) {
    ...
    function closeSubmenus() {
        ...
        $("[data-h2-menu-wrapper-0-0-9] [data-h2-menu] >[data-h2-menulist]").children("li").each(function() {
            if ($(this).children("[role='menuitem']")) {
        ...
        $(resetMainMenuItems).on("keydown.upDownArrow", function(e) {
            ...
            h2ComMenUpDownLoop009(e, key, resetMainMenuItems, itemCount);
        });
        $(resetMainMenuItems).on("keydown.rightArrow", function(e) {
            var key = e.keyCode || e.which;
            h2ComMenRightTrigger009(e, key, this, resetMainMenuItems);
        });
    }
    ...
    if ($("[data-h2-menu-wrapper-0-0-9] [data-h2-menu]").hasClass("h2-mobile-menu-active")) {
        ...
        var menuItemIndex = [];
        menuItemIndex = $(menuItemIndex).add($("[data-h2-menu-wrapper-0-0-9]").find(" [data-h2-mobile-menu-trigger]"));
        $("[data-h2-menu-wrapper-0-0-9] [data-h2-menu] >[data-h2-menulist]").children("li").each(function() {
            if ($(this).children("[role='menuitem']")) {
...
function h2ComMenMobileMenuToggle009(trigger) {
    var menu = $("[data-h2-menu-wrapper-0-0-9] [data-h2-menu]");
    // Close the menu.
    ...
    // Open the menu.
        ...
        $("[data-h2-menu-wrapper-0-0-9] [data-h2-menu] *").off("keydown.rightArrow");
        $("[data-h2-menu-wrapper-0-0-9] [data-h2-menu] *").off("keydown.escape");
        $("[data-h2-menu-wrapper-0-0-9] [data-h2-menu] *").off("keydown.mainTabExit");
        $("[data-h2-menu-wrapper-0-0-9] [data-h2-mobile-menu-trigger]").off("keydown.upDownArrow");
        $("[data-h2-menu-wrapper-0-0-9] [data-h2-mobile-menu-trigger]").off("keydown.rightArrow");
        $("[data-h2-menu-wrapper-0-0-9] [data-h2-mobile-menu-trigger]").off("keydown.escape");
        $("[data-h2-menu-wrapper-0-0-9] [data-h2-mobile-menu-trigger]").off("keydown.mainTabExit");
        // Get main menu items.
        var resetMainMenuItems = [];
        $("[data-h2-menu-wrapper-0-0-9] [data-h2-menu] >[data-h2-menulist]").children("li").each(function() {
            if ($(this).children("[role='menuitem']")) {
        ...
        $(resetMainMenuItems).on("keydown.mainTabExit", function(e) {
            var key = e.keyCode || e.which;
            h2ComMenMainTabExit009(e, key, this);
        });
        ...
        $(resetMainMenuItemsWithSubmenus).on("keydown.rightArrow", function(e) {
            var key = e.keyCode || e.which;
            h2ComMenRightTrigger009(e, key, this, resetMainMenuItemsWithSubmenus);
        });
...
function h2ComMenMobileMenuAnchorClick009(link) {
    if ($("[data-h2-menu-wrapper-0-0-9] [data-h2-menu]").hasClass("h2-mobile-menu-active")) {
...
$(document).ready(function () {
    ...
    $(mainMenuItems).on("keydown.upDownArrow", function(e) {
        ...
        h2ComMenUpDownLoop009(e, key, mainMenuItems, itemCount);
    });
    ...
    $(mainMenuItemsWithSubmenu).on("keydown.rightArrow", function(e) {
        var key = e.keyCode || e.which;
        h2ComMenRightTrigger009(e, key, this, mainMenuItemsWithSubmenu);
    });

    // Submenu trigger click.
    $("[data-h2-menu-wrapper-0-0-9] [data-h2-submenu-trigger]").on("click.toggleSubmenu", function() {
        h2ComMenToggleSubmenu009(this)
    });

    // Mobile Menu Trigger
    $("[data-h2-menu-wrapper-0-0-9] [data-h2-mobile-menu-trigger]").on("click.toggleMobileMenu", function(e) {
        e.preventDefault();
        h2ComMenMobileMenuToggle009(this);
    });

    // Mobile page anchor trigger.
    $("[data-h2-menu-wrapper-0-0-9] [data-h2-menu] [role='menuitem']").on("click.navigate", function(e) {
        h2ComMenMobileMenuAnchorClick009(this);
    });
