...
// Mobile Menu Scripts
    ...
    // Mobile Menu Tabbing
        ...
        // Tab Loop Function
        function h2ComMenMobileTabLoop001(e, menuItems, menuItemCount) {
        ...
        // Tab Loop Trigger
        function h2ComMenMobileMenuTabLoopTrigger001(menuItems) {
            ...
            $(menuItems).on("keydown.mobilemenutabloop", function(e) {
                h2ComMenMobileTabLoop001(e, menuItems, menuItemCount);
            });
        }
    ...
    // Mobile Menu Escape Events
        ...
        // Escape Function
        function h2ComMenMobileMenuEscape001(e, trigger, menu, menuItems) {
            var keyCode = e.keyCode || e.which;
            if (keyCode == 27) {
        ...
        // Escape Trigger
        function h2ComMenMobileMenuEscapeTrigger001(trigger, menu, menuItems) {
            // Trigger the escape event listener on the submenu items.
            $(menuItems).on("keydown.mobilemenuescape", function(e) {
                h2ComMenMobileMenuEscape001(e, trigger, menu, menuItems);
            });
        }
    ...
    // Mobile Menu Trigger
        ...
        // Trigger Function
        function h2ComMenMobileMenuToggle001(trigger) {
            // Create a variable for the menu.
            var menu = $("[data-h2-menu-wrapper-0-0-1] [data-h2-menu]");
            ...
            // If the mobile trigger is inactive, open the menu.
                ...
                h2ComMenMobileMenuTabLoopTrigger001(menuItems);
                h2ComMenMobileMenuEscapeTrigger001(trigger, menu, menuItems);
            }
        }

        // Event Listener
        $("[data-h2-menu-wrapper-0-0-1] [data-h2-mobile-menu-trigger]").on("click", function(e) {
            e.preventDefault();
            h2ComMenMobileMenuToggle001(this);
        });
    ...
    function h2ComMenMobileMenuAnchorClick001(trigger) {
        if ($("[data-h2-menu-wrapper-0-0-1] [data-h2-menu]").hasClass("h2-mobile-menu-active")) {
    ...
    $("[data-h2-menu-wrapper-0-0-1] [data-h2-menu] [role='menuitem']").on("click", function(e) {
        h2ComMenMobileMenuAnchorClick001(this);
    });
...
// Desktop Menu Scripts
    ...
    // Submenu Tab Loop
    function h2ComMenSubmenuTabLoop001(e, submenuItems, submenuItemCount) {
        var keyCode = e.keyCode || e.which;
        if (keyCode == 9 && !e.shiftKey) {
            e.preventDefault();
            var currentFocus = document.activeElement;
    ...
    function h2ComMenSubmenuTabLoopTrigger001(trigger, submenu) {
        ...
        $(submenuItems).on("keydown.submenutabloop", function(e) {
            h2ComMenSubmenuTabLoop001(e, submenuItems, submenuItemCount);
        });

    }

    // Submenu Escape Loop
    function h2ComMenSubmenuEscape001(e, trigger, parentMenuItem, parentSubmenu, parentSubmenuTrigger, submenu, submenuItems) {
        var keyCode = e.keyCode || e.which;
        if (keyCode == 27) {
            // Remove the current submenu's tab loop and escape event listeners.
            ...
            if ($(parentSubmenu).h2ComMenHasAttr001("data-h2-submenu") == true) {
                h2ComMenSubmenuTabLoopTrigger001(parentSubmenuTrigger, parentSubmenu);
                h2ComMenSubmenuEscapeTrigger001(parentSubmenuTrigger);
            }
            // Otherwise check to see if the parent is the main menu.
                ...
                var mobileTrigger = $(parentSubmenu).closest("[data-h2-menu-wrapper-0-0-1]").find("[data-h2-mobile-menu-trigger]");
                menuItems = $(menuItems).add($(mobileTrigger));
                // Enable the tab loop and escape event listeners.
                h2ComMenMobileMenuTabLoopTrigger001(menuItems);
                h2ComMenMobileMenuEscapeTrigger001(mobileTrigger, menu, menuItems);
            }
        }
    }

    function h2ComMenSubmenuEscapeTrigger001(trigger) {
        ...
        $(submenuItems).on("keydown.submenuescape", function(e) {
            h2ComMenSubmenuEscape001(e, trigger, parentMenuItem, parentSubmenu, parentSubmenuTrigger, submenu, submenuItems);
        });
    }
    ...
    // Submenu Trigger
        ...
        // Trigger Function
        function h2ComMenSubmenuToggle001(trigger) {
            ...
            // If the submenu isn't active, open it.
                ...
                h2ComMenSubmenuTabLoopTrigger001(trigger, submenu);
                // Add the escape event listeners to the newly opened submeny.
                h2ComMenSubmenuEscapeTrigger001(trigger);
            }

        }

        // Trigger Event
        $("[data-h2-menu-wrapper-0-0-1] [data-h2-submenu-trigger]").on("click.submenutrigger", function(e) {
            e.preventDefault();
            h2ComMenSubmenuToggle001(this);
        });