...
// Mobile Menu Scripts
    ...
    // Mobile Menu Tabbing
        ...
        // Tab Loop Function
        function h2ComMenMobileTabLoop004(e, menuItems, menuItemCount) {
        ...
        // Tab Loop Trigger
        function h2ComMenMobileMenuTabLoopTrigger004(menuItems) {
            ...
            $(menuItems).on("keydown.mobilemenutabloop", function(e) {
                h2ComMenMobileTabLoop004(e, menuItems, menuItemCount);
            });
        }
    ...
    // Mobile Menu Escape Events
        ...
        // Escape Function
        function h2ComMenMobileMenuEscape004(e, trigger, menu, menuItems) {
            var keyCode = e.keyCode || e.which;
            if (keyCode == 27) {
        ...
        // Escape Trigger
        function h2ComMenMobileMenuEscapeTrigger004(trigger, menu, menuItems) {
            // Trigger the escape event listener on the submenu items.
            $(menuItems).on("keydown.mobilemenuescape", function(e) {
                h2ComMenMobileMenuEscape004(e, trigger, menu, menuItems);
            });
        }
    ...
    // Mobile Menu Trigger
        ...
        // Trigger Function
        function h2ComMenMobileMenuToggle004(trigger) {
            // Create a variable for the menu.
            var menu = $("[data-h2-menu-wrapper-0-0-4] [data-h2-menu]");
            ...
            // If the mobile trigger is inactive, open the menu.
                ...
                h2ComMenMobileMenuTabLoopTrigger004(menuItems);
                h2ComMenMobileMenuEscapeTrigger004(trigger, menu, menuItems);
            }
        }

        // Event Listener
        $("[data-h2-menu-wrapper-0-0-4] [data-h2-mobile-menu-trigger]").on("click", function(e) {
            e.preventDefault();
            h2ComMenMobileMenuToggle004(this);
        });
    ...
    function h2ComMenMobileMenuAnchorClick004(trigger) {
        if ($("[data-h2-menu-wrapper-0-0-4] [data-h2-menu]").hasClass("h2-mobile-menu-active")) {
    ...
    $("[data-h2-menu-wrapper-0-0-4] [data-h2-menu] [role='menuitem']").on("click", function(e) {
        h2ComMenMobileMenuAnchorClick004(this);
    });
...
// Desktop Menu Scripts
    ...
    // Submenu Tab Loop
    function h2ComMenSubmenuTabLoop004(e, submenuItems, submenuItemCount) {
        var keyCode = e.keyCode || e.which;
        if (keyCode == 9 && !e.shiftKey) {
            e.preventDefault();
            var currentFocus = document.activeElement;
    ...
    function h2ComMenSubmenuTabLoopTrigger004(trigger, submenu) {
        ...
        $(submenuItems).on("keydown.submenutabloop", function(e) {
            h2ComMenSubmenuTabLoop004(e, submenuItems, submenuItemCount);
        });

    }

    // Submenu Escape Loop
    function h2ComMenSubmenuEscape004(e, trigger, parentMenuItem, parentSubmenu, parentSubmenuTrigger, submenu, submenuItems) {
        var keyCode = e.keyCode || e.which;
        if (keyCode == 27) {
            // Remove the current submenu's tab loop and escape event listeners.
            ...
            if ($(parentSubmenu).h2ComMenHasAttr004("data-h2-submenu") == true) {
                h2ComMenSubmenuTabLoopTrigger004(parentSubmenuTrigger, parentSubmenu);
                h2ComMenSubmenuEscapeTrigger004(parentSubmenuTrigger);
            }
            // Otherwise check to see if the parent is the main menu.
                ...
                var mobileTrigger = $(parentSubmenu).closest("[data-h2-menu-wrapper-0-0-4]").find("[data-h2-mobile-menu-trigger]");
                menuItems = $(menuItems).add($(mobileTrigger));
                // Enable the tab loop and escape event listeners.
                h2ComMenMobileMenuTabLoopTrigger004(menuItems);
                h2ComMenMobileMenuEscapeTrigger004(mobileTrigger, menu, menuItems);
            }
        }
    }

    function h2ComMenSubmenuEscapeTrigger004(trigger) {
        ...
        $(submenuItems).on("keydown.submenuescape", function(e) {
            h2ComMenSubmenuEscape004(e, trigger, parentMenuItem, parentSubmenu, parentSubmenuTrigger, submenu, submenuItems);
        });
    }
    ...
    // Submenu Trigger
        ...
        // Trigger Function
        function h2ComMenSubmenuToggle004(trigger) {
            ...
            // If the submenu isn't active, open it.
                ...
                h2ComMenSubmenuTabLoopTrigger004(trigger, submenu);
                // Add the escape event listeners to the newly opened submeny.
                h2ComMenSubmenuEscapeTrigger004(trigger);
            }

        }

        // Trigger Event
        $("[data-h2-menu-wrapper-0-0-4] [data-h2-submenu-trigger]").on("click.submenutrigger", function(e) {
            e.preventDefault();
            h2ComMenSubmenuToggle004(this);
        });