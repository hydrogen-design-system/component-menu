...
// "hasAttr" Function
$.fn.h2ComMenHasAttr0011 = function (name) {
...
// Toggle submenu.
  ...
  function h2ComMenOpenSubmenu0011(menuItem, subMenuTrigger) {
    ...
    $("[data-h2-menu-wrapper-0011] [data-h2-menu] *").off("keydown.upDownArrow");
    $("[data-h2-menu-wrapper-0011] [data-h2-menu] *").off("keydown.rightArrow");
    $("[data-h2-menu-wrapper-0011] [data-h2-menu] *").off("keydown.escape");
    $("[data-h2-menu-wrapper-0011] [data-h2-mobile-menu-trigger]").off("keydown.upDownArrow");
    $("[data-h2-menu-wrapper-0011] [data-h2-mobile-menu-trigger]").off("keydown.rightArrow");
    $("[data-h2-menu-wrapper-0011] [data-h2-mobile-menu-trigger]").off("keydown.escape");
  ...
  function h2ComMenCloseSubmenu0011(menuItem, subMenuTrigger) {
    ...
    if ($(menuItem).parent().parent().parent().h2ComMenHasAttr0011("data-h2-menu") == true) {
    ...
    if ($(menuItem).parent().parent("[data-h2-menulist]").parent().children("[data-h2-submenu-trigger]").length > 0) {
      ...
      if ($("[data-h2-menu-wrapper-0011] [data-h2-menu]").hasClass("h2-mobile-menu-active")) {
...
function h2ComMenEscapeTrigger0011(e, key, trigger) {
  if (key == 37 || key == 27) {
    ...
    if (trigger.getAttribute('role') === 'menuitem') {
      ...
      if ($(trigger).parent().parent().parent().h2ComMenHasAttr0011("data-h2-menu")) {
        // console.log("You're trying to close the main menu.");
        if ($("[data-h2-menu-wrapper-0011] [data-h2-menu]").hasClass("h2-mobile-menu-active")) {
          var menu = $("[data-h2-menu-wrapper-0011] [data-h2-menu]");
...
function h2ComMenMainTabExit0011(e, key, trigger) {
  ...
  function closeSubmenus() {
    ...
    $("[data-h2-menu-wrapper-0011] [data-h2-menu] >[data-h2-menulist]").each(function() {
      $(this).children("li").each(function() {
        if ($(this).children("[role='menuitem']")) {
  ...
  if ($("[data-h2-menu-wrapper-0011] [data-h2-menu]").hasClass("h2-mobile-menu-active")) {
    ...
    var menuItemIndex = [];
    menuItemIndex = $(menuItemIndex).add($("[data-h2-menu-wrapper-0011]").find(" [data-h2-mobile-menu-trigger]"));
    $("[data-h2-menu-wrapper-0011] [data-h2-menu] >[data-h2-menulist]").each(function() {
      $(this).children("li").each(function() {
        if ($(this).children("[role='menuitem']")) {
...
function h2ComMenMobileMenuToggle0011(trigger) {
  ...
  // Open the menu.
    ...
    $("[data-h2-menu-wrapper-0011] [data-h2-menu] *").off("keydown.rightArrow");
    $("[data-h2-menu-wrapper-0011] [data-h2-menu] *").off("keydown.escape");
    $("[data-h2-menu-wrapper-0011] [data-h2-menu] *").off("keydown.mainTabExit");
    $("[data-h2-menu-wrapper-0011] [data-h2-mobile-menu-trigger]").off("keydown.upDownArrow");
    $("[data-h2-menu-wrapper-0011] [data-h2-mobile-menu-trigger]").off("keydown.rightArrow");
    $("[data-h2-menu-wrapper-0011] [data-h2-mobile-menu-trigger]").off("keydown.escape");
    $("[data-h2-menu-wrapper-0011] [data-h2-mobile-menu-trigger]").off("keydown.mainTabExit");
    // Get main menu items.
    var resetMainMenuItems = [];
    $("[data-h2-menu-wrapper-0011] [data-h2-menu] >[data-h2-menulist]").each(function() {
      $(this).children("li").each(function() {
    ...
    $("[data-h2-menu-wrapper-0011] [data-h2-menu] [data-h2-menulist]").children("li").each(function() {
      if ($(this).children("[role='menuitem']")) {
...
function test70011() {
  ...
  $("[data-h2-menu-wrapper-0011] [data-h2-submenu-trigger]").on("click.toggleSubmenu", function() {
...
function test80011() {
  // Mobile Menu Trigger
  $("[data-h2-menu-wrapper-0011] [data-h2-mobile-menu-trigger]").on("click.toggleMobileMenu", function(e) {
    e.preventDefault();
...
function test90011() {
  ...
  $("[data-h2-menu-wrapper-0011] [data-h2-menu] [role='menuitem']").on("click.navigate", function() {
...
export {test20011, test40011, test60011, test70011, test80011, test90011};