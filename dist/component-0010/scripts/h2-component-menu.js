...
exports.test20010 = test20010;
exports.test40010 = test40010;
exports.test60010 = test60010;
exports.test70010 = test70010;
exports.test80010 = test80010;
exports.test90010 = test90010;
...
// "hasAttr" Function
_cashDom.default.fn.h2ComMenHasAttr0010 = function (name) {
...
function h2ComMenOpenSubmenu0010(menuItem, subMenuTrigger) {
  // Open the submenu.
  ...
  (0, _cashDom.default)("[data-h2-menu-wrapper-0010] [data-h2-menu] *").off("keydown.upDownArrow");
  (0, _cashDom.default)("[data-h2-menu-wrapper-0010] [data-h2-menu] *").off("keydown.rightArrow");
  (0, _cashDom.default)("[data-h2-menu-wrapper-0010] [data-h2-menu] *").off("keydown.escape");
  (0, _cashDom.default)("[data-h2-menu-wrapper-0010] [data-h2-mobile-menu-trigger]").off("keydown.upDownArrow");
  (0, _cashDom.default)("[data-h2-menu-wrapper-0010] [data-h2-mobile-menu-trigger]").off("keydown.rightArrow");
  (0, _cashDom.default)("[data-h2-menu-wrapper-0010] [data-h2-mobile-menu-trigger]").off("keydown.escape"); // Find submenu and it's items.
...
function h2ComMenCloseSubmenu0010(menuItem, subMenuTrigger) {
  ...
  (0, _cashDom.default)("[data-h2-menu-wrapper-0010] [data-h2-mobile-menu-trigger]").off("keydown.upDownArrow");
  (0, _cashDom.default)("[data-h2-menu-wrapper-0010] [data-h2-mobile-menu-trigger]").off("keydown.rightArrow");
  (0, _cashDom.default)("[data-h2-menu-wrapper-0010] [data-h2-mobile-menu-trigger]").off("keydown.escape"); // Find parent menu and its items.

  var parentMenuItems = []; // Check to see if the main menu is the parent, and whether it is split.

  if ((0, _cashDom.default)(menuItem).parent().parent().parent().h2ComMenHasAttr0010("data-h2-menu") == true) {
  ...
  if ((0, _cashDom.default)(menuItem).parent().parent("[data-h2-menulist]").parent().children("[data-h2-submenu-trigger]").length > 0) {
    ...
    if ((0, _cashDom.default)("[data-h2-menu-wrapper-0010] [data-h2-menu]").hasClass("h2-mobile-menu-active")) {
  ...
  (0, _cashDom.default)(parentMenuItems).on("keydown.upDownArrow", function (e) {
    ...
    h2ComMenUpDownLoop0010(e, key, parentMenuItems, itemCount);
  });
...
function h2ComMenToggleSubmenu0010(trigger) {
  ...
  if ((0, _cashDom.default)(trigger).parent().hasClass("h2-active")) {
    h2ComMenCloseSubmenu0010(menuItem, subMenuTrigger);
  } else {
    h2ComMenOpenSubmenu0010(menuItem, subMenuTrigger);
  }
} // Up/down arrow loop.


function h2ComMenUpDownLoop0010(e, key, items, itemCount) {
  // Next item
  if (key == 40) {
    e.preventDefault();
...
function h2ComMenRightTrigger0010(e, key, trigger) {
  if (key == 39) {
    ...
    if ((0, _cashDom.default)(trigger).siblings("[data-h2-menulist]").length > 0) {
      if ((0, _cashDom.default)(trigger).parent().hasClass("h2-active")) {// Do nothing.
        ...
        // Open the submenu.
        h2ComMenToggleSubmenu0010(trigger);
      }
    }
  }
...
function h2ComMenEscapeTrigger0010(e, key, trigger) {
  if (key == 37 || key == 27) {
    ...
    if (trigger.getAttribute('role') === 'menuitem') {
      ...
      if ((0, _cashDom.default)(trigger).parent().parent().parent().h2ComMenHasAttr0010("data-h2-menu")) {
        // console.log("You're trying to close the main menu.");
        if ((0, _cashDom.default)("[data-h2-menu-wrapper-0010] [data-h2-menu]").hasClass("h2-mobile-menu-active")) {
          var menu = (0, _cashDom.default)("[data-h2-menu-wrapper-0010] [data-h2-menu]"); // Remove event listeners from all menus.
          ...
          (0, _cashDom.default)("[data-h2-menu-wrapper-0010] [data-h2-mobile-menu-trigger]").off("keydown.upDownArrow");
          (0, _cashDom.default)("[data-h2-menu-wrapper-0010] [data-h2-mobile-menu-trigger]").off("keydown.rightArrow");
          (0, _cashDom.default)("[data-h2-menu-wrapper-0010] [data-h2-mobile-menu-trigger]").off("keydown.escape"); // Close all submenus.
...
function h2ComMenMainTabExit0010(e, key, trigger) {
  ...
  function closeSubmenus() {
    ...
    (0, _cashDom.default)("[data-h2-menu-wrapper-0010] [data-h2-menu] >[data-h2-menulist]").each(function () {
      (0, _cashDom.default)(this).children("li").each(function () {
        if ((0, _cashDom.default)(this).children("[role='menuitem']")) {
    ...
    (0, _cashDom.default)(resetMainMenuItems).on("keydown.upDownArrow", function (e) {
      ...
      h2ComMenUpDownLoop0010(e, key, resetMainMenuItems, itemCount);
    });
    (0, _cashDom.default)(resetMainMenuItems).on("keydown.rightArrow", function (e) {
      var key = e.keyCode || e.which;
      h2ComMenRightTrigger0010(e, key, this, resetMainMenuItems);
    });
  } // If the menu is mobile activated, you need to close the main menu on tab out of the first or last items.


  if ((0, _cashDom.default)("[data-h2-menu-wrapper-0010] [data-h2-menu]").hasClass("h2-mobile-menu-active")) {
    var menu = (0, _cashDom.default)("[data-h2-menu-wrapper-0010] [data-h2-menu]"); // Create an index of the main menu items, including the mobile trigger (this should be first in the order).

    var menuItemIndex = [];
    menuItemIndex = (0, _cashDom.default)(menuItemIndex).add((0, _cashDom.default)("[data-h2-menu-wrapper-0010]").find(" [data-h2-mobile-menu-trigger]"));
    (0, _cashDom.default)("[data-h2-menu-wrapper-0010] [data-h2-menu] >[data-h2-menulist]").each(function () {
      (0, _cashDom.default)(this).children("li").each(function () {
        if ((0, _cashDom.default)(this).children("[role='menuitem']")) {
...
function h2ComMenMobileMenuToggle0010(trigger) {
  var menu = (0, _cashDom.default)("[data-h2-menu-wrapper-0010] [data-h2-menu]"); // Close the menu.
  ...
  if ((0, _cashDom.default)(trigger).hasClass("h2-active")) {
    ...
    (0, _cashDom.default)("body").removeClass("h2-mobile-menu-body-lock");
      ...
      (0, _cashDom.default)("[data-h2-menu-wrapper-0010] [data-h2-menu] *").off("keydown.rightArrow");
      (0, _cashDom.default)("[data-h2-menu-wrapper-0010] [data-h2-menu] *").off("keydown.escape");
      (0, _cashDom.default)("[data-h2-menu-wrapper-0010] [data-h2-menu] *").off("keydown.mainTabExit");
      (0, _cashDom.default)("[data-h2-menu-wrapper-0010] [data-h2-mobile-menu-trigger]").off("keydown.upDownArrow");
      (0, _cashDom.default)("[data-h2-menu-wrapper-0010] [data-h2-mobile-menu-trigger]").off("keydown.rightArrow");
      (0, _cashDom.default)("[data-h2-menu-wrapper-0010] [data-h2-mobile-menu-trigger]").off("keydown.escape");
      (0, _cashDom.default)("[data-h2-menu-wrapper-0010] [data-h2-mobile-menu-trigger]").off("keydown.mainTabExit"); // Get main menu items.
      ...
      (0, _cashDom.default)(resetMainMenuItems).on("keydown.mainTabExit", function (e) {
        var key = e.keyCode || e.which;
        h2ComMenMainTabExit0010(e, key, this);
      ...
      (0, _cashDom.default)(resetMainMenuItemsWithSubmenus).on("keydown.rightArrow", function (e) {
        var key = e.keyCode || e.which;
        h2ComMenRightTrigger0010(e, key, this, resetMainMenuItemsWithSubmenus);
      }); // Add tab listeners to tab out of the menu and close submenus.

      var resetAllMenuItems = [];
      (0, _cashDom.default)("[data-h2-menu-wrapper-0010] [data-h2-menu] [data-h2-menulist]").children("li").each(function () {
        if ((0, _cashDom.default)(this).children("[role='menuitem']")) {
...
function h2ComMenMobileMenuAnchorClick0010(link) {
  if ((0, _cashDom.default)("[data-h2-menu-wrapper-0010] [data-h2-menu]").hasClass("h2-mobile-menu-active")) {
...
function test20010() {
  ...
  (0, _cashDom.default)(mainMenuItems).on("keydown.upDownArrow", function (e) {
    ...
    h2ComMenUpDownLoop0010(e, key, mainMenuItems, itemCount);
  });
}
...
function test60010() {
  ...
  (0, _cashDom.default)(mainMenuItemsWithSubmenu).on("keydown.rightArrow", function (e) {
    var key = e.keyCode || e.which;
    h2ComMenRightTrigger0010(e, key, this, mainMenuItemsWithSubmenu);
  });
}

function test70010() {
  // Submenu trigger click.
  (0, _cashDom.default)("[data-h2-menu-wrapper-0010] [data-h2-submenu-trigger]").on("click.toggleSubmenu", function () {
    h2ComMenToggleSubmenu0010(this);
  });
}

function test80010() {
  // Mobile Menu Trigger
  (0, _cashDom.default)("[data-h2-menu-wrapper-0010] [data-h2-mobile-menu-trigger]").on("click.toggleMobileMenu", function (e) {
    e.preventDefault();
    h2ComMenMobileMenuToggle0010(this);
  });
}

function test90010() {
  // Mobile page anchor trigger.
  (0, _cashDom.default)("[data-h2-menu-wrapper-0010] [data-h2-menu] [role='menuitem']").on("click.navigate", function () {
    h2ComMenMobileMenuAnchorClick0010(this);
  });
} // Page Load
...
},{"cash-dom":2}],2:[function(require,module,exports){
