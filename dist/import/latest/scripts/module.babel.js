...
exports.h2ComMenAddUpDownToMainMenuItems = h2ComMenAddUpDownToMainMenuItems;
exports.h2ComMenAddTabEvents = h2ComMenAddTabEvents;
exports.h2ComMenAddRightArrowToMainMenuItemsWithSubmenus = h2ComMenAddRightArrowToMainMenuItemsWithSubmenus;
exports.h2ComMenAddSubmenuTriggerEvents = h2ComMenAddSubmenuTriggerEvents;
exports.h2ComMenAddMobileMenuTriggerEvent = h2ComMenAddMobileMenuTriggerEvent;
exports.h2ComMenAddPageAnchorEvents = h2ComMenAddPageAnchorEvents;
...
// "hasAttr" Function
_cashDom.default.fn.h2ComMenHasAttr = function (name) {
...
function h2ComMenOpenSubmenu(menuItem, subMenuTrigger) {
  ...
  (0, _cashDom.default)("[data-h2-menu-wrapper] [data-h2-menu] *").off("keydown.upDownArrow");
  (0, _cashDom.default)("[data-h2-menu-wrapper] [data-h2-menu] *").off("keydown.rightArrow");
  (0, _cashDom.default)("[data-h2-menu-wrapper] [data-h2-menu] *").off("keydown.escape");
  (0, _cashDom.default)("[data-h2-menu-wrapper] [data-h2-mobile-menu-trigger]").off("keydown.upDownArrow");
  (0, _cashDom.default)("[data-h2-menu-wrapper] [data-h2-mobile-menu-trigger]").off("keydown.rightArrow");
  (0, _cashDom.default)("[data-h2-menu-wrapper] [data-h2-mobile-menu-trigger]").off("keydown.escape"); // Find submenu and it's items.
...
function h2ComMenCloseSubmenu(menuItem, subMenuTrigger) {
  ...
  (0, _cashDom.default)("[data-h2-menu-wrapper] [data-h2-mobile-menu-trigger]").off("keydown.upDownArrow");
  (0, _cashDom.default)("[data-h2-menu-wrapper] [data-h2-mobile-menu-trigger]").off("keydown.rightArrow");
  (0, _cashDom.default)("[data-h2-menu-wrapper] [data-h2-mobile-menu-trigger]").off("keydown.escape"); // Find parent menu and its items.
    ...
    if (trigger.getAttribute('role') === 'menuitem') {
      ...
      if ((0, _cashDom.default)(trigger).parent().parent().parent().h2ComMenHasAttr("data-h2-menu")) {
        ...
        if ((0, _cashDom.default)("[data-h2-menu-wrapper] [data-h2-menu]").hasClass("h2-mobile-menu-active")) {
          ...
          (0, _cashDom.default)("[data-h2-menu-wrapper] [data-h2-mobile-menu-trigger]").off("keydown.upDownArrow");
          (0, _cashDom.default)("[data-h2-menu-wrapper] [data-h2-mobile-menu-trigger]").off("keydown.rightArrow");
          (0, _cashDom.default)("[data-h2-menu-wrapper] [data-h2-mobile-menu-trigger]").off("keydown.escape"); // Close all submenus.
...
function h2ComMenMainTabExit(e, key, trigger) {
  ...
  if ((0, _cashDom.default)("[data-h2-menu-wrapper] [data-h2-menu]").hasClass("h2-mobile-menu-active")) {
    var menu = (0, _cashDom.default)("[data-h2-menu-wrapper] [data-h2-menu]"); // Create an index of the main menu items, including the mobile trigger (this should be first in the order).
...
function h2ComMenMobileMenuToggle(trigger) {
  var menu = (0, _cashDom.default)("[data-h2-menu-wrapper] [data-h2-menu]"); // Close the menu.
  ...
  if ((0, _cashDom.default)(trigger).hasClass("h2-active")) {
    ...
    (0, _cashDom.default)("body").removeClass("h2-mobile-menu-body-lock");
      ...
      (0, _cashDom.default)("[data-h2-menu-wrapper] [data-h2-menu] *").off("keydown.rightArrow");
      (0, _cashDom.default)("[data-h2-menu-wrapper] [data-h2-menu] *").off("keydown.escape");
      (0, _cashDom.default)("[data-h2-menu-wrapper] [data-h2-menu] *").off("keydown.mainTabExit");
      (0, _cashDom.default)("[data-h2-menu-wrapper] [data-h2-mobile-menu-trigger]").off("keydown.upDownArrow");
      (0, _cashDom.default)("[data-h2-menu-wrapper] [data-h2-mobile-menu-trigger]").off("keydown.rightArrow");
      (0, _cashDom.default)("[data-h2-menu-wrapper] [data-h2-mobile-menu-trigger]").off("keydown.escape");
...
function h2ComMenMobileMenuAnchorClick(link) {
  if ((0, _cashDom.default)("[data-h2-menu-wrapper] [data-h2-menu]").hasClass("h2-mobile-menu-active")) {
    ...
    if (destination.match("^#")) {
      var menuType = "";
      var menuAttr = (0, _cashDom.default)(link).closest("[data-h2-menu-wrapper]").attr("data-h2-menu-wrapper");
      ...
      if (menuType == "top") {
        ...
        (0, _cashDom.default)("[data-h2-menu-wrapper] [data-h2-mobile-menu-trigger]").off("keydown.upDownArrow");
        (0, _cashDom.default)("[data-h2-menu-wrapper] [data-h2-mobile-menu-trigger]").off("keydown.rightArrow");
        (0, _cashDom.default)("[data-h2-menu-wrapper] [data-h2-mobile-menu-trigger]").off("keydown.escape"); // Enable main menu.
  ...
  if (system == null || system == "") {
    ...
    (0, _cashDom.default)("[data-h2-menu-wrapper] [data-h2-menu] >[data-h2-menulist]").each(function () {
      ...
      if ((0, _cashDom.default)(this).closest("[data-h2-menu-wrapper]").h2ComMenHasAttr("data-h2-system")) {
        ...
        if ((0, _cashDom.default)(this).closest("[data-h2-menu-wrapper]").attr("data-h2-system") == system) {
          (0, _cashDom.default)(this).children("li").each(function () {
            if ((0, _cashDom.default)(this).children("[role='menuitem']")) {
              mainMenuItems = (0, _cashDom.default)(mainMenuItems).add((0, _cashDom.default)(this).children("[role='menuitem']"));
            }
