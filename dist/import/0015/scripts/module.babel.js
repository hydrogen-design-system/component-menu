...
exports.h2ComMenAddUpDownToMainMenuItems0015 = h2ComMenAddUpDownToMainMenuItems0015;
exports.h2ComMenAddTabEvents0015 = h2ComMenAddTabEvents0015;
exports.h2ComMenAddRightArrowToMainMenuItemsWithSubmenus0015 = h2ComMenAddRightArrowToMainMenuItemsWithSubmenus0015;
exports.h2ComMenAddSubmenuTriggerEvents0015 = h2ComMenAddSubmenuTriggerEvents0015;
exports.h2ComMenAddMobileMenuTriggerEvent0015 = h2ComMenAddMobileMenuTriggerEvent0015;
exports.h2ComMenAddPageAnchorEvents0015 = h2ComMenAddPageAnchorEvents0015;
...
// "hasAttr" Function
_cashDom.default.fn.h2ComMenHasAttr0015 = function (name) {
...
function h2ComMenOpenSubmenu0015(menuItem, subMenuTrigger) {
  // Open the submenu.
  ...
  (0, _cashDom.default)("[data-h2-menu-wrapper-0015] [data-h2-menu] *").off("keydown.upDownArrow");
  (0, _cashDom.default)("[data-h2-menu-wrapper-0015] [data-h2-menu] *").off("keydown.rightArrow");
  (0, _cashDom.default)("[data-h2-menu-wrapper-0015] [data-h2-menu] *").off("keydown.escape");
  (0, _cashDom.default)("[data-h2-menu-wrapper-0015] [data-h2-mobile-menu-trigger]").off("keydown.upDownArrow");
  (0, _cashDom.default)("[data-h2-menu-wrapper-0015] [data-h2-mobile-menu-trigger]").off("keydown.rightArrow");
  (0, _cashDom.default)("[data-h2-menu-wrapper-0015] [data-h2-mobile-menu-trigger]").off("keydown.escape"); // Find submenu and it's items.
...
function h2ComMenCloseSubmenu0015(menuItem, subMenuTrigger) {
  ...
  (0, _cashDom.default)("[data-h2-menu-wrapper-0015] [data-h2-mobile-menu-trigger]").off("keydown.upDownArrow");
  (0, _cashDom.default)("[data-h2-menu-wrapper-0015] [data-h2-mobile-menu-trigger]").off("keydown.rightArrow");
  (0, _cashDom.default)("[data-h2-menu-wrapper-0015] [data-h2-mobile-menu-trigger]").off("keydown.escape"); // Find parent menu and its items.

  var parentMenuItems = []; // Check to see if the main menu is the parent, and whether it is split.

  if ((0, _cashDom.default)(menuItem).parent().parent().parent().h2ComMenHasAttr0015("data-h2-menu") == true) {
  ...
  if ((0, _cashDom.default)(menuItem).parent().parent("[data-h2-menulist]").parent().children("[data-h2-submenu-trigger]").length > 0) {
    ...
    if ((0, _cashDom.default)("[data-h2-menu-wrapper-0015] [data-h2-menu]").hasClass("h2-mobile-menu-active")) {
  ...
  (0, _cashDom.default)(parentMenuItems).on("keydown.upDownArrow", function (e) {
    ...
    h2ComMenUpDownLoop0015(e, key, parentMenuItems, itemCount);
  });
...
function h2ComMenToggleSubmenu0015(trigger) {
  ...
  if ((0, _cashDom.default)(trigger).parent().hasClass("h2-active")) {
    h2ComMenCloseSubmenu0015(menuItem, subMenuTrigger);
  } else {
    h2ComMenOpenSubmenu0015(menuItem, subMenuTrigger);
  }
} // Up/down arrow loop.


function h2ComMenUpDownLoop0015(e, key, items, itemCount) {
  // Next item
  if (key == 40) {
    e.preventDefault();
...
function h2ComMenRightTrigger0015(e, key, trigger) {
  if (key == 39) {
    ...
    if ((0, _cashDom.default)(trigger).siblings("[data-h2-menulist]").length > 0) {
      if ((0, _cashDom.default)(trigger).parent().hasClass("h2-active")) {
        ...
        // Open the submenu.
        h2ComMenToggleSubmenu0015(trigger);
      }
    }
  }
...
function h2ComMenEscapeTrigger0015(e, key, trigger) {
  if (key == 37 || key == 27) {
    ...
    if (trigger.getAttribute('role') === 'menuitem') {
      ...
      if ((0, _cashDom.default)(trigger).parent().parent().parent().h2ComMenHasAttr0015("data-h2-menu")) {
        // console.log("You're trying to close the main menu.");
        if ((0, _cashDom.default)("[data-h2-menu-wrapper-0015] [data-h2-menu]").hasClass("h2-mobile-menu-active")) {
          var menu = (0, _cashDom.default)("[data-h2-menu-wrapper-0015] [data-h2-menu]"); // Remove event listeners from all menus.
          ...
          (0, _cashDom.default)("[data-h2-menu-wrapper-0015] [data-h2-mobile-menu-trigger]").off("keydown.upDownArrow");
          (0, _cashDom.default)("[data-h2-menu-wrapper-0015] [data-h2-mobile-menu-trigger]").off("keydown.rightArrow");
          (0, _cashDom.default)("[data-h2-menu-wrapper-0015] [data-h2-mobile-menu-trigger]").off("keydown.escape"); // Close all submenus.
...
function h2ComMenMainTabExit0015(e, key, trigger) {
  ...
  function closeSubmenus() {
    ...
    (0, _cashDom.default)("[data-h2-menu-wrapper-0015] [data-h2-menu] >[data-h2-menulist]").each(function () {
      (0, _cashDom.default)(this).children("li").each(function () {
        if ((0, _cashDom.default)(this).children("[role='menuitem']")) {
    ...
    (0, _cashDom.default)(resetMainMenuItems).on("keydown.upDownArrow", function (e) {
      ...
      h2ComMenUpDownLoop0015(e, key, resetMainMenuItems, itemCount);
    });
    (0, _cashDom.default)(resetMainMenuItems).on("keydown.rightArrow", function (e) {
      var key = e.keyCode || e.which;
      h2ComMenRightTrigger0015(e, key, this, resetMainMenuItems);
    });
  } // If the menu is mobile activated, you need to close the main menu on tab out of the first or last items.


  if ((0, _cashDom.default)("[data-h2-menu-wrapper-0015] [data-h2-menu]").hasClass("h2-mobile-menu-active")) {
    var menu = (0, _cashDom.default)("[data-h2-menu-wrapper-0015] [data-h2-menu]"); // Create an index of the main menu items, including the mobile trigger (this should be first in the order).

    var menuItemIndex = [];
    menuItemIndex = (0, _cashDom.default)(menuItemIndex).add((0, _cashDom.default)("[data-h2-menu-wrapper-0015]").find(" [data-h2-mobile-menu-trigger]"));
    (0, _cashDom.default)("[data-h2-menu-wrapper-0015] [data-h2-menu] >[data-h2-menulist]").each(function () {
      (0, _cashDom.default)(this).children("li").each(function () {
        if ((0, _cashDom.default)(this).children("[role='menuitem']")) {
...
function h2ComMenMobileMenuToggle0015(trigger) {
  var menu = (0, _cashDom.default)("[data-h2-menu-wrapper-0015] [data-h2-menu]"); // Close the menu.
  ...
  if ((0, _cashDom.default)(trigger).hasClass("h2-active")) {
    ...
    (0, _cashDom.default)("body").removeClass("h2-mobile-menu-body-lock");
      ...
      (0, _cashDom.default)("[data-h2-menu-wrapper-0015] [data-h2-menu] *").off("keydown.rightArrow");
      (0, _cashDom.default)("[data-h2-menu-wrapper-0015] [data-h2-menu] *").off("keydown.escape");
      (0, _cashDom.default)("[data-h2-menu-wrapper-0015] [data-h2-menu] *").off("keydown.mainTabExit");
      (0, _cashDom.default)("[data-h2-menu-wrapper-0015] [data-h2-mobile-menu-trigger]").off("keydown.upDownArrow");
      (0, _cashDom.default)("[data-h2-menu-wrapper-0015] [data-h2-mobile-menu-trigger]").off("keydown.rightArrow");
      (0, _cashDom.default)("[data-h2-menu-wrapper-0015] [data-h2-mobile-menu-trigger]").off("keydown.escape");
      (0, _cashDom.default)("[data-h2-menu-wrapper-0015] [data-h2-mobile-menu-trigger]").off("keydown.mainTabExit"); // Get main menu items.
      ...
      (0, _cashDom.default)(resetMainMenuItems).on("keydown.mainTabExit", function (e) {
        var key = e.keyCode || e.which;
        h2ComMenMainTabExit0015(e, key, this);
      ...
      (0, _cashDom.default)(resetMainMenuItemsWithSubmenus).on("keydown.rightArrow", function (e) {
        var key = e.keyCode || e.which;
        h2ComMenRightTrigger0015(e, key, this, resetMainMenuItemsWithSubmenus);
      }); // Add tab listeners to tab out of the menu and close submenus.

      var resetAllMenuItems = [];
      (0, _cashDom.default)("[data-h2-menu-wrapper-0015] [data-h2-menu] [data-h2-menulist]").children("li").each(function () {
        if ((0, _cashDom.default)(this).children("[role='menuitem']")) {
...
function h2ComMenMobileMenuAnchorClick0015(link) {
  if ((0, _cashDom.default)("[data-h2-menu-wrapper-0015] [data-h2-menu]").hasClass("h2-mobile-menu-active")) {
    ...
    if (destination.match("^#")) {
      var menuType = "";
      var menuAttr = (0, _cashDom.default)(link).closest("[data-h2-menu-wrapper-0015]").attr("data-h2-menu-wrapper-0015");
      ...
      if (menuType == "top") {
        ...
        (0, _cashDom.default)("[data-h2-menu-wrapper-0015] [data-h2-mobile-menu-trigger]").off("keydown.upDownArrow");
        (0, _cashDom.default)("[data-h2-menu-wrapper-0015] [data-h2-mobile-menu-trigger]").off("keydown.rightArrow");
        (0, _cashDom.default)("[data-h2-menu-wrapper-0015] [data-h2-mobile-menu-trigger]").off("keydown.escape"); // Enable main menu.
        ...
        (0, _cashDom.default)(mainMenuItems).on("keydown.upDownArrow", function (e) {
          ...
          h2ComMenUpDownLoop0015(e, key, mainMenuItems, itemCount);
        }); // Right
        ...
        (0, _cashDom.default)(mainMenuItemsWithSubmenu).on("keydown.rightArrow", function (e) {
          var key = e.keyCode || e.which;
          h2ComMenRightTrigger0015(e, key, this, mainMenuItemsWithSubmenu);
        });
      }
    }
  }
...
function h2ComMenAddUpDownToMainMenuItems0015(system) {
  ...
  if (system == null || system == "") {
    ...
    (0, _cashDom.default)("[data-h2-menu-wrapper-0015] [data-h2-menu] >[data-h2-menulist]").each(function () {
      ...
      if ((0, _cashDom.default)(this).closest("[data-h2-menu-wrapper-0015]").h2ComMenHasAttr0015("data-h2-system")) {
        // Check if the system attribute matches the current system version.
        if ((0, _cashDom.default)(this).closest("[data-h2-menu-wrapper-0015]").attr("data-h2-system") == system) {
          (0, _cashDom.default)(this).children("li").each(function () {
            if ((0, _cashDom.default)(this).children("[role='menuitem']")) {
              mainMenuItems = (0, _cashDom.default)(mainMenuItems).add((0, _cashDom.default)(this).children("[role='menuitem']"));
            }
...
function h2ComMenAddTabEvents0015(system) {
  // Determine where the module is being loaded from. If the module is being loaded from the system, the event should only be applied to the component when it exists within the system's enabler selector (data-h2-system). This check ensures that any code that is loaded by the system is instanced and can be overridden by previous versions if need be.
  var allMenuItems = [];
...
function h2ComMenAddRightArrowToMainMenuItemsWithSubmenus0015(system) {
  // Determine where the module is being loaded from. If the module is being loaded from the system, the event should only be applied to the component when it exists within the system's enabler selector (data-h2-system). This check ensures that any code that is loaded by the system is instanced and can be overridden by previous versions if need be.
  var mainMenuItemsWithSubmenu = [];
...
function h2ComMenAddSubmenuTriggerEvents0015(system) {
  // Determine where the module is being loaded from. If the module is being loaded from the system, the event should only be applied to the component when it exists within the system's enabler selector (data-h2-system). This check ensures that any code that is loaded by the system is instanced and can be overridden by previous versions if need be.
  var submenuTriggers = [];

  if (system == null || system == "") {
    submenuTriggers = (0, _cashDom.default)("[data-h2-menu-wrapper-0015] [data-h2-submenu-trigger]");
  } else {
    (0, _cashDom.default)("[data-h2-menu-wrapper-0015] [data-h2-submenu-trigger]").each(function () {
      // Check if the menu wrapper has the system attribute.
      if ((0, _cashDom.default)(this).closest("[data-h2-menu-wrapper-0015]").h2ComMenHasAttr0015("data-h2-system")) {
        // Check if the system attribute matches the current system version.
        if ((0, _cashDom.default)(this).closest("[data-h2-menu-wrapper-0015]").attr("data-h2-system") == system) {
  ...
  (0, _cashDom.default)(submenuTriggers).on("click.toggleSubmenu", function () {
    h2ComMenToggleSubmenu0015(this);
  });
}

function h2ComMenAddMobileMenuTriggerEvent0015(system) {
  // Determine where the module is being loaded from. If the module is being loaded from the system, the event should only be applied to the component when it exists within the system's enabler selector (data-h2-system). This check ensures that any code that is loaded by the system is instanced and can be overridden by previous versions if need be.
  var mobileTriggers = [];

  if (system == null || system == "") {
    mobileTriggers = (0, _cashDom.default)("[data-h2-menu-wrapper-0015] [data-h2-mobile-menu-trigger]");
  } else {
    (0, _cashDom.default)("[data-h2-menu-wrapper-0015] [data-h2-mobile-menu-trigger]").each(function () {
      // Check if the menu wrapper has the system attribute.
      if ((0, _cashDom.default)(this).closest("[data-h2-menu-wrapper-0015]").h2ComMenHasAttr0015("data-h2-system")) {
        // Check if the system attribute matches the current system version.
        if ((0, _cashDom.default)(this).closest("[data-h2-menu-wrapper-0015]").attr("data-h2-system") == system) {
  ...
  (0, _cashDom.default)(mobileTriggers).on("click.toggleMobileMenu", function (e) {
    e.preventDefault();
    h2ComMenMobileMenuToggle0015(this);
  });
}

function h2ComMenAddPageAnchorEvents0015(system) {
  // Determine where the module is being loaded from. If the module is being loaded from the system, the event should only be applied to the component when it exists within the system's enabler selector (data-h2-system). This check ensures that any code that is loaded by the system is instanced and can be overridden by previous versions if need be.
  var menuItems = [];

  if (system == null || system == "") {
    menuItems = (0, _cashDom.default)("[data-h2-menu-wrapper-0015] [data-h2-menu] [role='menuitem']");
  } else {
    (0, _cashDom.default)("[data-h2-menu-wrapper-0015] [data-h2-menu] [role='menuitem']").each(function () {
      // Check if the menu wrapper has the system attribute.
      if ((0, _cashDom.default)(this).closest("[data-h2-menu-wrapper-0015]").h2ComMenHasAttr0015("data-h2-system")) {
        // Check if the system attribute matches the current system version.
        if ((0, _cashDom.default)(this).closest("[data-h2-menu-wrapper-0015]").attr("data-h2-system") == system) {
  ...
  (0, _cashDom.default)(menuItems).on("click.navigate", function () {
    h2ComMenMobileMenuAnchorClick0015(this);
  });
}