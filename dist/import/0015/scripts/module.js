...
// "hasAttr" Function
$.fn.h2ComMenHasAttr0015 = function (name) {
...
// Toggle submenu.
  ...
  function h2ComMenOpenSubmenu0015(menuItem, subMenuTrigger) {
    ...
    $("[data-h2-menu-wrapper-0015] [data-h2-menu] *").off("keydown.upDownArrow");
    $("[data-h2-menu-wrapper-0015] [data-h2-menu] *").off("keydown.rightArrow");
    $("[data-h2-menu-wrapper-0015] [data-h2-menu] *").off("keydown.escape");
    $("[data-h2-menu-wrapper-0015] [data-h2-mobile-menu-trigger]").off("keydown.upDownArrow");
    $("[data-h2-menu-wrapper-0015] [data-h2-mobile-menu-trigger]").off("keydown.rightArrow");
    $("[data-h2-menu-wrapper-0015] [data-h2-mobile-menu-trigger]").off("keydown.escape");
  ...
  function h2ComMenCloseSubmenu0015(menuItem, subMenuTrigger) {
    ...
    if ($(menuItem).parent().parent().parent().h2ComMenHasAttr0015("data-h2-menu") == true) {
    ...
    if ($(menuItem).parent().parent("[data-h2-menulist]").parent().children("[data-h2-submenu-trigger]").length > 0) {
      ...
      if ($("[data-h2-menu-wrapper-0015] [data-h2-menu]").hasClass("h2-mobile-menu-active")) {
...
function h2ComMenEscapeTrigger0015(e, key, trigger) {
  if (key == 37 || key == 27) {
    ...
    if (trigger.getAttribute('role') === 'menuitem') {
      ...
      if ($(trigger).parent().parent().parent().h2ComMenHasAttr0015("data-h2-menu")) {
        // console.log("You're trying to close the main menu.");
        if ($("[data-h2-menu-wrapper-0015] [data-h2-menu]").hasClass("h2-mobile-menu-active")) {
          var menu = $("[data-h2-menu-wrapper-0015] [data-h2-menu]");
...
function h2ComMenMainTabExit0015(e, key, trigger) {
  ...
  function closeSubmenus() {
    ...
    $("[data-h2-menu-wrapper-0015] [data-h2-menu] >[data-h2-menulist]").each(function() {
      $(this).children("li").each(function() {
        if ($(this).children("[role='menuitem']")) {
  ...
  if ($("[data-h2-menu-wrapper-0015] [data-h2-menu]").hasClass("h2-mobile-menu-active")) {
    ...
    var menuItemIndex = [];
    menuItemIndex = $(menuItemIndex).add($("[data-h2-menu-wrapper-0015]").find(" [data-h2-mobile-menu-trigger]"));
    $("[data-h2-menu-wrapper-0015] [data-h2-menu] >[data-h2-menulist]").each(function() {
      $(this).children("li").each(function() {
        if ($(this).children("[role='menuitem']")) {
...
function h2ComMenMobileMenuToggle0015(trigger) {
  ...
  // Open the menu.
    ...
    $("[data-h2-menu-wrapper-0015] [data-h2-menu] *").off("keydown.rightArrow");
    $("[data-h2-menu-wrapper-0015] [data-h2-menu] *").off("keydown.escape");
    $("[data-h2-menu-wrapper-0015] [data-h2-menu] *").off("keydown.mainTabExit");
    $("[data-h2-menu-wrapper-0015] [data-h2-mobile-menu-trigger]").off("keydown.upDownArrow");
    $("[data-h2-menu-wrapper-0015] [data-h2-mobile-menu-trigger]").off("keydown.rightArrow");
    $("[data-h2-menu-wrapper-0015] [data-h2-mobile-menu-trigger]").off("keydown.escape");
    $("[data-h2-menu-wrapper-0015] [data-h2-mobile-menu-trigger]").off("keydown.mainTabExit");
    // Get main menu items.
    var resetMainMenuItems = [];
    $("[data-h2-menu-wrapper-0015] [data-h2-menu] >[data-h2-menulist]").each(function() {
      $(this).children("li").each(function() {
    ...
    $("[data-h2-menu-wrapper-0015] [data-h2-menu] [data-h2-menulist]").children("li").each(function() {
      if ($(this).children("[role='menuitem']")) {
...
function h2ComMenMobileMenuAnchorClick0015(link) {
  if ($("[data-h2-menu-wrapper-0015] [data-h2-menu]").hasClass("h2-mobile-menu-active")) {
    ...
    if (destination.match("^#")) {
      var menuType = "";
      var menuAttr = $(link).closest("[data-h2-menu-wrapper-0015]").attr("data-h2-menu-wrapper-0015");
...
function h2ComMenAddUpDownToMainMenuItems0015(system) {
  ...
  if (system == null || system == "") {
    ...
    $("[data-h2-menu-wrapper-0015] [data-h2-menu] >[data-h2-menulist]").each(function() {
      ...
      if ($(this).closest("[data-h2-menu-wrapper-0015]").h2ComMenHasAttr0015("data-h2-system")) {
        // Check if the system attribute matches the current system version.
        if ($(this).closest("[data-h2-menu-wrapper-0015]").attr("data-h2-system") == system){
          $(this).children("li").each(function() {
            if ($(this).children("[role='menuitem']")) {
              mainMenuItems = $(mainMenuItems).add($(this).children("[role='menuitem']"));
            }
...
function h2ComMenAddSubmenuTriggerEvents0015(system) {
  ...
  var submenuTriggers = [];
  if (system == null || system == "") {
    submenuTriggers = $("[data-h2-menu-wrapper-0015] [data-h2-submenu-trigger]");
  } 
  else {
    $("[data-h2-menu-wrapper-0015] [data-h2-submenu-trigger]").each(function() {
      // Check if the menu wrapper has the system attribute.
      if ($(this).closest("[data-h2-menu-wrapper-0015]").h2ComMenHasAttr0015("data-h2-system")) {
        // Check if the system attribute matches the current system version.
        if ($(this).closest("[data-h2-menu-wrapper-0015]").attr("data-h2-system") == system) {
...
function h2ComMenAddMobileMenuTriggerEvent0015(system) {
  ...
  var mobileTriggers = [];
  if (system == null || system == "") {
    mobileTriggers = $("[data-h2-menu-wrapper-0015] [data-h2-mobile-menu-trigger]");
  } else {
    $("[data-h2-menu-wrapper-0015] [data-h2-mobile-menu-trigger]").each(function() {
      // Check if the menu wrapper has the system attribute.
      if ($(this).closest("[data-h2-menu-wrapper-0015]").h2ComMenHasAttr0015("data-h2-system")) {
        // Check if the system attribute matches the current system version.
        if ($(this).closest("[data-h2-menu-wrapper-0015]").attr("data-h2-system") == system) {
...
function h2ComMenAddPageAnchorEvents0015(system) {
  ...
  var menuItems = [];
  if (system == null || system == "") {
    menuItems = $("[data-h2-menu-wrapper-0015] [data-h2-menu] [role='menuitem']");
  } else {
    $("[data-h2-menu-wrapper-0015] [data-h2-menu] [role='menuitem']").each(function() {
      // Check if the menu wrapper has the system attribute.
      if ($(this).closest("[data-h2-menu-wrapper-0015]").h2ComMenHasAttr0015("data-h2-system")) {
        // Check if the system attribute matches the current system version.
        if ($(this).closest("[data-h2-menu-wrapper-0015]").attr("data-h2-system") == system) {
...
export {
  h2ComMenAddUpDownToMainMenuItems0015, 
  h2ComMenAddTabEvents0015, 
  h2ComMenAddRightArrowToMainMenuItemsWithSubmenus0015, 
  h2ComMenAddSubmenuTriggerEvents0015, 
  h2ComMenAddMobileMenuTriggerEvent0015, 
  h2ComMenAddPageAnchorEvents0015
};