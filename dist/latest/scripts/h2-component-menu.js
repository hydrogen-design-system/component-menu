...
function test7() {
  ...
  (0, _cashDom.default)("[data-h2-menu-wrapper] [data-h2-submenu-trigger]").on("click.toggleSubmenu", function () {
...
function test8() {
  // Mobile Menu Trigger
  (0, _cashDom.default)("[data-h2-menu-wrapper] [data-h2-mobile-menu-trigger]").on("click.toggleMobileMenu", function (e) {
    e.preventDefault();
...
function test9() {
  ...
  (0, _cashDom.default)("[data-h2-menu-wrapper] [data-h2-menu] [role='menuitem']").on("click.navigate", function () {
