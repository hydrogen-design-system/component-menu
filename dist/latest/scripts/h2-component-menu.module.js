...
// Toggle submenu.
  ...
  function h2ComMenCloseSubmenu(menuItem, subMenuTrigger) {
    ...
    if ($(menuItem).parent().parent().parent().h2ComMenHasAttr("data-h2-menu") == true) {
...
function h2ComMenEscapeTrigger(e, key, trigger) {
  if (key == 37 || key == 27) {
    ...
    if (trigger.getAttribute('role') === 'menuitem') {
      ...
      if ($(trigger).parent().parent().parent().h2ComMenHasAttr("data-h2-menu")) {
...
function test7() {
  ...
  $("[data-h2-menu-wrapper] [data-h2-submenu-trigger]").on("click.toggleSubmenu", function() {
...
function test8() {
  // Mobile Menu Trigger
  $("[data-h2-menu-wrapper] [data-h2-mobile-menu-trigger]").on("click.toggleMobileMenu", function(e) {
    e.preventDefault();
...
function test9() {
  ...
  $("[data-h2-menu-wrapper] [data-h2-menu] [role='menuitem']").on("click.navigate", function() {
...
export {test2, test4, test6, test7, test8, test9};