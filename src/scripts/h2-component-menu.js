...
function test7_VERSION() {
  // Submenu trigger click.
  $("[data-h2-menu-wrapper_VERSION] [data-h2-submenu-trigger]").on("click.toggleSubmenu", function() {
    h2ComMenToggleSubmenu_VERSION(this);
  });
}

function test8_VERSION() {
  // Mobile Menu Trigger
...
export {test2_VERSION, test4_VERSION, test6_VERSION, test7_VERSION, test8_VERSION, test9_VERSION};