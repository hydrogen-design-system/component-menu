...
// "hasAttr" Function
$.fn.h2ComMenHasAttr$H2VERJS = function (name) {
...
// Toggle submenu.
    ...
    // Open script.
    function h2ComMenOpenSubmenu$H2VERJS(menuItem, subMenuTrigger) {
        // Open the submenu.
        ...
        $("[data-h2-menu-wrapper$H2VERCSS] [data-h2-menu] *").off("keydown.rightArrow");
        $("[data-h2-menu-wrapper$H2VERCSS] [data-h2-menu] *").off("keydown.escape");
        $("[data-h2-menu-wrapper$H2VERCSS] [data-h2-mobile-menu-trigger]").off("keydown.upDownArrow");
        $("[data-h2-menu-wrapper$H2VERCSS] [data-h2-mobile-menu-trigger]").off("keydown.rightArrow");
        $("[data-h2-menu-wrapper$H2VERCSS] [data-h2-mobile-menu-trigger]").off("keydown.escape");
        ...
        $(subMenuItems).on("keydown.rightArrow", function(e) {
            ...
            h2ComMenRightTrigger$H2VERJS(e, key, this);
        });
        $(subMenuItems).on("keydown.upDownArrow", function(e) {
            var key = e.keyCode || e.which;
            var itemCount = $(subMenuItems).length - 1;
            h2ComMenUpDownLoop$H2VERJS(e, key, subMenuItems, itemCount);
        });
        $(subMenuItems).on("keydown.escape", function(e) {
            var key = e.keyCode || e.which;
            h2ComMenEscapeTrigger$H2VERJS(e, key, this);
        });
    ...
    // Close script.
    function h2ComMenCloseSubmenu$H2VERJS(menuItem, subMenuTrigger) {
        // Remove all event listeners.
        $("[data-h2-menu-wrapper$H2VERCSS] [data-h2-menu] *").off("keydown.upDownArrow");
        $("[data-h2-menu-wrapper$H2VERCSS] [data-h2-menu] *").off("keydown.rightArrow");
        $("[data-h2-menu-wrapper$H2VERCSS] [data-h2-menu] *").off("keydown.escape");
        ...
        $(parentMenuItems).on("keydown.upDownArrow", function(e) {
            ...
            h2ComMenUpDownLoop$H2VERJS(e, key, parentMenuItems, itemCount);
        });
    ...
    function h2ComMenToggleSubmenu$H2VERJS(trigger) {
        ...
        if ($(trigger).parent().hasClass("h2-active")) {
            h2ComMenCloseSubmenu$H2VERJS(menuItem, subMenuTrigger);
        } else {
            h2ComMenOpenSubmenu$H2VERJS(menuItem, subMenuTrigger);
        }
    }

// Up/down arrow loop.
function h2ComMenUpDownLoop$H2VERJS(e, key, items, itemCount) {
    // Next item
    if (key == 40) {
        e.preventDefault();
...
function h2ComMenRightTrigger$H2VERJS(e, key, trigger) {
    if (key == 39) {
        e.preventDefault();
        ...
        if ($(trigger).siblings("[data-h2-menulist]").length > 0) {
            if ($(trigger).parent().hasClass("h2-active")) {
                ...
                // Open the submenu.
                h2ComMenToggleSubmenu$H2VERJS(trigger);
            }
        }
    }
}
...
function h2ComMenEscapeTrigger$H2VERJS(e, key, trigger) {
    if (key == 37 || key == 27) {
        e.preventDefault();
...
function h2ComMenMainTabExit$H2VERJS(e, key, trigger) {
    ...
    function closeSubmenus() {
        ...
        $("[data-h2-menu-wrapper$H2VERCSS] [data-h2-menu] >[data-h2-menulist]").children("li").each(function() {
            if ($(this).children("[role='menuitem']")) {
        ...
        $(resetMainMenuItems).on("keydown.upDownArrow", function(e) {
            ...
            h2ComMenUpDownLoop$H2VERJS(e, key, resetMainMenuItems, itemCount);
        });
        $(resetMainMenuItems).on("keydown.rightArrow", function(e) {
            var key = e.keyCode || e.which;
            h2ComMenRightTrigger$H2VERJS(e, key, this, resetMainMenuItems);
        });
    }
    ...
    if ($("[data-h2-menu-wrapper$H2VERCSS] [data-h2-menu]").hasClass("h2-mobile-menu-active")) {
        ...
        var menuItemIndex = [];
        menuItemIndex = $(menuItemIndex).add($("[data-h2-menu-wrapper$H2VERCSS]").find(" [data-h2-mobile-menu-trigger]"));
        $("[data-h2-menu-wrapper$H2VERCSS] [data-h2-menu] >[data-h2-menulist]").children("li").each(function() {
            if ($(this).children("[role='menuitem']")) {
...
function h2ComMenMobileMenuToggle$H2VERJS(trigger) {
    var menu = $("[data-h2-menu-wrapper$H2VERCSS] [data-h2-menu]");
    // Close the menu.
    ...
    // Open the menu.
        ...
        $("[data-h2-menu-wrapper$H2VERCSS] [data-h2-menu] *").off("keydown.rightArrow");
        $("[data-h2-menu-wrapper$H2VERCSS] [data-h2-menu] *").off("keydown.escape");
        $("[data-h2-menu-wrapper$H2VERCSS] [data-h2-menu] *").off("keydown.mainTabExit");
        $("[data-h2-menu-wrapper$H2VERCSS] [data-h2-mobile-menu-trigger]").off("keydown.upDownArrow");
        $("[data-h2-menu-wrapper$H2VERCSS] [data-h2-mobile-menu-trigger]").off("keydown.rightArrow");
        $("[data-h2-menu-wrapper$H2VERCSS] [data-h2-mobile-menu-trigger]").off("keydown.escape");
        $("[data-h2-menu-wrapper$H2VERCSS] [data-h2-mobile-menu-trigger]").off("keydown.mainTabExit");
        // Get main menu items.
        var resetMainMenuItems = [];
        $("[data-h2-menu-wrapper$H2VERCSS] [data-h2-menu] >[data-h2-menulist]").children("li").each(function() {
            if ($(this).children("[role='menuitem']")) {
        ...
        $(resetMainMenuItems).on("keydown.mainTabExit", function(e) {
            var key = e.keyCode || e.which;
            h2ComMenMainTabExit$H2VERJS(e, key, this);
        });
        ...
        $(resetMainMenuItemsWithSubmenus).on("keydown.rightArrow", function(e) {
            var key = e.keyCode || e.which;
            h2ComMenRightTrigger$H2VERJS(e, key, this, resetMainMenuItemsWithSubmenus);
        });
...
function h2ComMenMobileMenuAnchorClick$H2VERJS(link) {
    if ($("[data-h2-menu-wrapper$H2VERCSS] [data-h2-menu]").hasClass("h2-mobile-menu-active")) {
...
$(document).ready(function () {
    ...
    $(mainMenuItems).on("keydown.upDownArrow", function(e) {
        ...
        h2ComMenUpDownLoop$H2VERJS(e, key, mainMenuItems, itemCount);
    });
    ...
    $(mainMenuItemsWithSubmenu).on("keydown.rightArrow", function(e) {
        var key = e.keyCode || e.which;
        h2ComMenRightTrigger$H2VERJS(e, key, this, mainMenuItemsWithSubmenu);
    });

    // Submenu trigger click.
    $("[data-h2-menu-wrapper$H2VERCSS] [data-h2-submenu-trigger]").on("click.toggleSubmenu", function() {
        h2ComMenToggleSubmenu$H2VERJS(this)
    });

    // Mobile Menu Trigger
    $("[data-h2-menu-wrapper$H2VERCSS] [data-h2-mobile-menu-trigger]").on("click.toggleMobileMenu", function(e) {
        e.preventDefault();
        h2ComMenMobileMenuToggle$H2VERJS(this);
    });

    // Mobile page anchor trigger.
    $("[data-h2-menu-wrapper$H2VERCSS] [data-h2-menu] [role='menuitem']").on("click.navigate", function(e) {
        h2ComMenMobileMenuAnchorClick$H2VERJS(this);
    });
