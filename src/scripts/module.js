...
// "hasAttr" Function
$.fn.h2ComMenHasAttr_VERSION = function (name) {
...
// Toggle submenu.
  ...
  // Open script.
  function h2ComMenOpenSubmenu_VERSION(menuItem, subMenuTrigger) {
    // Open the submenu.
    ...
    $(subMenuItems).on("keydown.rightArrow", function(e) {
      ...
      h2ComMenRightTrigger_VERSION(e, key, this);
    });
    $(subMenuItems).on("keydown.upDownArrow", function(e) {
      var key = e.keyCode || e.which;
      var itemCount = $(subMenuItems).length - 1;
      h2ComMenUpDownLoop_VERSION(e, key, subMenuItems, itemCount);
    });
  ...
  // Close script.
  function h2ComMenCloseSubmenu_VERSION(menuItem, subMenuTrigger) {
    // Remove all event listeners.
    $("[data-h2-menu-wrapper_VERSION] [data-h2-menu] *").off("keydown.upDownArrow");
    $("[data-h2-menu-wrapper_VERSION] [data-h2-menu] *").off("keydown.rightArrow");
    $("[data-h2-menu-wrapper_VERSION] [data-h2-menu] *").off("keydown.escape");
    ...
    if ($(menuItem).parent().parent().parent().h2ComMenHasAttr_VERSION("data-h2-menu-container") == true) {
    ...
    $(parentMenuItems).on("keydown.upDownArrow", function(e) {
      ...
      h2ComMenUpDownLoop_VERSION(e, key, parentMenuItems, itemCount);
    });
  ...
  function h2ComMenToggleSubmenu_VERSION(trigger) {
...
// Up/down arrow loop.
function h2ComMenUpDownLoop_VERSION(e, key, items, itemCount) {
  // Next item
  if (key == 40) {
    e.preventDefault();
...
function h2ComMenRightTrigger_VERSION(e, key, trigger) {
  if (key == 39) {
    e.preventDefault();
    ...
    if ($(trigger).siblings("[data-h2-menulist]").length > 0) {
      if ($(trigger).parent().hasClass("h2-active")) {
        ...
        // Open the submenu.
        h2ComMenToggleSubmenu_VERSION(trigger);
      }
    }
  }
}
...
function h2ComMenEscapeTrigger_VERSION(e, key, trigger) {
  if (key == 37 || key == 27) {
    e.preventDefault();
    ...
    if (trigger.getAttribute('role') === 'menuitem') {
      ...
      if ($(trigger).parent().parent().parent().h2ComMenHasAttr_VERSION("data-h2-menu-container")) {
...
function h2ComMenMainTabExit_VERSION(e, key, trigger) {
  ...
  function closeSubmenus() {
    ...
    $("[data-h2-menu-wrapper_VERSION] [data-h2-menu] [data-h2-menu-container] >[data-h2-menulist]").each(function() {
      $(this).children("li").each(function() {
        if ($(this).children("[role='menuitem']")) {
    ...
    $(resetMainMenuItems).on("keydown.rightArrow", function(e) {
      var key = e.keyCode || e.which;
      h2ComMenRightTrigger_VERSION(e, key, this, resetMainMenuItems);
    });
  }
  ...
  if ($("[data-h2-menu-wrapper_VERSION] [data-h2-menu]").hasClass("h2-mobile-menu-active")) {
    ...
    var menuItemIndex = [];
    menuItemIndex = $(menuItemIndex).add($("[data-h2-menu-wrapper_VERSION]").find(" [data-h2-mobile-menu-trigger]"));
    $("[data-h2-menu-wrapper_VERSION] [data-h2-menu] [data-h2-menu-container] >[data-h2-menulist]").each(function() {
      $(this).children("li").each(function() {
        if ($(this).children("[role='menuitem']")) {
...
function h2ComMenMobileMenuAnchorClick_VERSION(link) {
  if ($("[data-h2-menu-wrapper_VERSION] [data-h2-menu]").hasClass("h2-mobile-menu-active")) {
    ...
    if (destination.match("^#")) {
      var menuType = "";
      var menuAttr = $(link).closest("[data-h2-menu-wrapper_VERSION]").attr("data-h2-menu-wrapper_VERSION");
      ...
      if (menuType == "top") {
        ...
        $(mainMenuItems).on("keydown.upDownArrow", function(e) {
          ...
          h2ComMenUpDownLoop_VERSION(e, key, mainMenuItems, itemCount);
        });
        // Right
        ...
        $(mainMenuItemsWithSubmenu).on("keydown.rightArrow", function(e) {
          var key = e.keyCode || e.which;
          h2ComMenRightTrigger_VERSION(e, key, this, mainMenuItemsWithSubmenu);
        });
      }
    }
  }
...
function h2ComMenAddUpDownToMainMenuItems_VERSION(system) {
  ...
  if (system == null || system == "" || system == "latest") {
    ...
    $("[data-h2-menu-wrapper_VERSION] [data-h2-menu] [data-h2-menu-container] >[data-h2-menulist]").each(function() {
      ...
      if ($(this).closest("[data-h2-menu-wrapper_VERSION]").h2ComMenHasAttr_VERSION("data-h2-system")) {
        // Check if the system attribute matches the current system version.
        if ($(this).closest("[data-h2-menu-wrapper_VERSION]").attr("data-h2-system") == system){
          $(this).children("li").each(function() {
            if ($(this).children("[role='menuitem']")) {
              mainMenuItems = $(mainMenuItems).add($(this).children("[role='menuitem']"));
            }
...
function h2ComMenAddTabEvents_VERSION(system) {
...
function h2ComMenAddRightArrowToMainMenuItemsWithSubmenus_VERSION(system) {
...
function h2ComMenAddSubmenuTriggerEvents_VERSION(system) {

  // Determine where the module is being loaded from. If the module is being loaded from the system, the event should only be applied to the component when it exists within the system's enabler selector (data-h2-system). This check ensures that any code that is loaded by the system is instanced and can be overridden by previous versions if need be.
  var submenuTriggers = [];
  if (system == null || system == "" || system == "latest") {
    submenuTriggers = $("[data-h2-menu-wrapper_VERSION] [data-h2-submenu-trigger]");
  } 
  else {
    $("[data-h2-menu-wrapper_VERSION] [data-h2-submenu-trigger]").each(function() {
      // Check if the menu wrapper has the system attribute.
      if ($(this).closest("[data-h2-menu-wrapper_VERSION]").h2ComMenHasAttr_VERSION("data-h2-system")) {
        // Check if the system attribute matches the current system version.
        if ($(this).closest("[data-h2-menu-wrapper_VERSION]").attr("data-h2-system") == system) {
  ...
  $(submenuTriggers).on("click.toggleSubmenu", function() {
    h2ComMenToggleSubmenu_VERSION(this);
  });

}

function h2ComMenAddMobileMenuTriggerEvent_VERSION(system) {

  // Determine where the module is being loaded from. If the module is being loaded from the system, the event should only be applied to the component when it exists within the system's enabler selector (data-h2-system). This check ensures that any code that is loaded by the system is instanced and can be overridden by previous versions if need be.
  var mobileTriggers = [];
  if (system == null || system == "" || system == "latest") {
    mobileTriggers = $("[data-h2-menu-wrapper_VERSION] [data-h2-mobile-menu-trigger]");
  } else {
    $("[data-h2-menu-wrapper_VERSION] [data-h2-mobile-menu-trigger]").each(function() {
      // Check if the menu wrapper has the system attribute.
      if ($(this).closest("[data-h2-menu-wrapper_VERSION]").h2ComMenHasAttr_VERSION("data-h2-system")) {
        // Check if the system attribute matches the current system version.
        if ($(this).closest("[data-h2-menu-wrapper_VERSION]").attr("data-h2-system") == system) {
...
function h2ComMenAddPageAnchorEvents_VERSION(system) {

  // Determine where the module is being loaded from. If the module is being loaded from the system, the event should only be applied to the component when it exists within the system's enabler selector (data-h2-system). This check ensures that any code that is loaded by the system is instanced and can be overridden by previous versions if need be.
  var menuItems = [];
  if (system == null || system == "" || system == "latest") {
    menuItems = $("[data-h2-menu-wrapper_VERSION] [data-h2-menu] [role='menuitem']");
  } else {
    $("[data-h2-menu-wrapper_VERSION] [data-h2-menu] [role='menuitem']").each(function() {
      // Check if the menu wrapper has the system attribute.
      if ($(this).closest("[data-h2-menu-wrapper_VERSION]").h2ComMenHasAttr_VERSION("data-h2-system")) {
        // Check if the system attribute matches the current system version.
        if ($(this).closest("[data-h2-menu-wrapper_VERSION]").attr("data-h2-system") == system) {
...
export {
  h2ComMenAddUpDownToMainMenuItems_VERSION, 
  h2ComMenAddTabEvents_VERSION, 
  h2ComMenAddRightArrowToMainMenuItemsWithSubmenus_VERSION, 
  h2ComMenAddSubmenuTriggerEvents_VERSION, 
  h2ComMenAddMobileMenuTriggerEvent_VERSION, 
  h2ComMenAddPageAnchorEvents_VERSION
};